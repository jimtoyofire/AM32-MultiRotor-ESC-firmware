...
uint8_t TEMPERATURE_LIMIT = 90;  // degrees 255 to disable
char advance_level = 3;			// 7.5 degree increments 0 , 7.5, 15, 22.5)
uint16_t motor_kv = 2040;
char motor_poles = 14;
uint16_t CURRENT_LIMIT = 202;
uint8_t sine_mode_power = 7;
